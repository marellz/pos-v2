<template>
  <div ref="dropdown" class="relative">
    ...
    <ul v-show="active"
      class="absolute top-full transform translate-y-1 z-10 bg-slate-800 rounded-lg shadow border border-slate-700 py-2 right-0">
      <slot />
    </ul>
  </div>
</template>
...
withDefaults(defineProps<{
  ...
  triggerClass: 'py-1 px-1.5 hover:bg-slate-100/10 rounded-lg'
