<template>
  <div
    class="fixed bg-black/10 inset-0 z-20 flex justify-center items-start p-4 backdrop-blur-sm overflow-auto"
  ...
  >
    <layout-card ref="modal" class="w-full" :class="width">
      <div class="flex items-center">
        ...
        <button
          type="button"
          class="hover:bg-black/10 p-2 rounded-full ml-auto"
          @click="close"
        >
          <X :size="24"></X>
        </button>
...
import LayoutCard from "@/components/base/card.vue"
